    ...
    <header class="header">
      ...
      <nav class="main-nav">
        <ul class="main-nav-list">
          ...
          <!-- <li><a class="main-nav-link nav-cta" href="#">Plan In use</a></li> -->
        </ul>
      </nav>
    </header>
        ...
        <div class="container grid grid--2-cols margin-bottom-md">
          <div class="princing-plan princing-plan--starter">
            ...
            <div class="plan-sing-up">
              <p  style='background-color : pink; color: black;'class="btn btn--full">29 days left</p>
            </div>
          </div>
          ...
          <div class="princing-plan princing-plan--complete">
            ...
            <div class="plan-sing-up">
              <a href="#" class="btn btn--full">UPGRADE</a>
            </div>
          </div>
        </div>
